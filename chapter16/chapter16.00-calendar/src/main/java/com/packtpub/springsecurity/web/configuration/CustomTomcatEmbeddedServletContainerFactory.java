...
@Configuration
@Profile({"TLS"})
public final class CustomTomcatEmbeddedServletContainerFactory {
...
//        tomcat.addAdditionalTomcatConnectors(tlsConnector());
    ...
    /**
     * Note this connector uses 'tomcat.keystore' instead of
     * 'jbcp_clientauth.p12' for key/trust store
     *
